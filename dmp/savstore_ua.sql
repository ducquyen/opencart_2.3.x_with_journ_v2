...
DROP TABLE IF EXISTS `ocs_address`;
CREATE TABLE `ocs_address` (
...
DROP TABLE IF EXISTS `ocs_affiliate`;
CREATE TABLE `ocs_affiliate` (
...
DROP TABLE IF EXISTS `ocs_affiliate_activity`;
CREATE TABLE `ocs_affiliate_activity` (
...
DROP TABLE IF EXISTS `ocs_affiliate_login`;
CREATE TABLE `ocs_affiliate_login` (
...
DROP TABLE IF EXISTS `ocs_affiliate_transaction`;
CREATE TABLE `ocs_affiliate_transaction` (
...
DROP TABLE IF EXISTS `ocs_api`;
CREATE TABLE `ocs_api` (
...
INSERT INTO `ocs_api` (`api_id`, `name`, `key`, `status`, `date_added`, `date_modified`) VALUES
(1,	'Default',	'',	1,	'2016-09-12 10:06:30',	'2016-09-12 10:06:30');

DROP TABLE IF EXISTS `ocs_api_ip`;
CREATE TABLE `ocs_api_ip` (
...
DROP TABLE IF EXISTS `ocs_api_session`;
CREATE TABLE `ocs_api_session` (
...
DROP TABLE IF EXISTS `ocs_attribute`;
CREATE TABLE `ocs_attribute` (
...
INSERT INTO `ocs_attribute` (`attribute_id`, `attribute_group_id`, `sort_order`) VALUES
(1,	6,	1),
(2,	6,	5),
(3,	6,	3),
(4,	3,	1),
...
DROP TABLE IF EXISTS `ocs_attribute_description`;
CREATE TABLE `ocs_attribute_description` (
...
INSERT INTO `ocs_attribute_description` (`attribute_id`, `language_id`, `name`) VALUES
(1,	1,	'Description'),
(2,	1,	'No. of Cores'),
(4,	1,	'test 1'),
(5,	1,	'test 2'),
...
DROP TABLE IF EXISTS `ocs_attribute_group`;
CREATE TABLE `ocs_attribute_group` (
  `attribute_group_id` int(11) NOT NULL AUTO_INCREMENT,
  `sort_order` int(3) NOT NULL,
  PRIMARY KEY (`attribute_group_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

INSERT INTO `ocs_attribute_group` (`attribute_group_id`, `sort_order`) VALUES
(3,	2),
(4,	1),
(5,	3),
(6,	4);

DROP TABLE IF EXISTS `ocs_attribute_group_description`;
CREATE TABLE `ocs_attribute_group_description` (
  `attribute_group_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(64) NOT NULL,
...
INSERT INTO `ocs_attribute_group_description` (`attribute_group_id`, `language_id`, `name`) VALUES
(3,	1,	'Memory'),
(4,	1,	'Technical'),
(5,	1,	'Motherboard'),
(6,	1,	'Processor');

DROP TABLE IF EXISTS `ocs_banner`;
CREATE TABLE `ocs_banner` (
...
INSERT INTO `ocs_banner` (`banner_id`, `name`, `status`) VALUES
(6,	'HP Products',	1),
(7,	'Home Page Slideshow',	1),
(8,	'Manufacturers',	1);

DROP TABLE IF EXISTS `ocs_banner_image`;
CREATE TABLE `ocs_banner_image` (
...
INSERT INTO `ocs_banner_image` (`banner_image_id`, `banner_id`, `language_id`, `title`, `link`, `image`, `sort_order`) VALUES
...
DROP TABLE IF EXISTS `ocs_cart`;
CREATE TABLE `ocs_cart` (
...
DROP TABLE IF EXISTS `ocs_category`;
CREATE TABLE `ocs_category` (
...
INSERT INTO `ocs_category` (`category_id`, `image`, `parent_id`, `top`, `column`, `sort_order`, `status`, `date_added`, `date_modified`) VALUES
...
DROP TABLE IF EXISTS `ocs_category_description`;
CREATE TABLE `ocs_category_description` (
...
INSERT INTO `ocs_category_description` (`category_id`, `language_id`, `name`, `description`, `meta_title`, `meta_description`, `meta_keyword`) VALUES
...
DROP TABLE IF EXISTS `ocs_category_filter`;
CREATE TABLE `ocs_category_filter` (
  `category_id` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `ocs_category_path`;
CREATE TABLE `ocs_category_path` (
  `category_id` int(11) NOT NULL,
...
INSERT INTO `ocs_category_path` (`category_id`, `path_id`, `level`) VALUES
(25,	25,	0),
(28,	25,	0),
(28,	28,	1),
(35,	25,	0),
...
DROP TABLE IF EXISTS `ocs_category_to_layout`;
CREATE TABLE `ocs_category_to_layout` (
  `category_id` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `ocs_category_to_store`;
CREATE TABLE `ocs_category_to_store` (
  `category_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  PRIMARY KEY (`category_id`,`store_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

INSERT INTO `ocs_category_to_store` (`category_id`, `store_id`) VALUES
(17,	0),
(18,	0),
(20,	0),
(24,	0),
...
DROP TABLE IF EXISTS `ocs_country`;
CREATE TABLE `ocs_country` (
...
INSERT INTO `ocs_country` (`country_id`, `name`, `iso_code_2`, `iso_code_3`, `address_format`, `postcode_required`, `status`) VALUES
...
DROP TABLE IF EXISTS `ocs_coupon`;
CREATE TABLE `ocs_coupon` (
...
INSERT INTO `ocs_coupon` (`coupon_id`, `name`, `code`, `type`, `discount`, `logged`, `shipping`, `total`, `date_start`, `date_end`, `uses_total`, `uses_customer`, `status`, `date_added`) VALUES
(4,	'-10% Discount',	'2222',	'P',	10.0000,	0,	0,	0.0000,	'2014-01-01',	'2020-01-01',	10,	'10',	0,	'2009-01-27 13:55:03'),
(5,	'Free Shipping',	'3333',	'P',	0.0000,	0,	1,	100.0000,	'2014-01-01',	'2014-02-01',	10,	'10',	0,	'2009-03-14 21:13:53'),
(6,	'-10.00 Discount',	'1111',	'F',	10.0000,	0,	0,	10.0000,	'2014-01-01',	'2020-01-01',	100000,	'10000',	0,	'2009-03-14 21:15:18');

DROP TABLE IF EXISTS `ocs_coupon_category`;
CREATE TABLE `ocs_coupon_category` (
...
DROP TABLE IF EXISTS `ocs_coupon_history`;
CREATE TABLE `ocs_coupon_history` (
...
DROP TABLE IF EXISTS `ocs_coupon_product`;
CREATE TABLE `ocs_coupon_product` (
...
DROP TABLE IF EXISTS `ocs_currency`;
CREATE TABLE `ocs_currency` (
...
INSERT INTO `ocs_currency` (`currency_id`, `title`, `code`, `symbol_left`, `symbol_right`, `decimal_place`, `value`, `status`, `date_modified`) VALUES
(1,	'Рубль',	'RUB',	'',	'р.',	'0',	1.00000000,	1,	'2016-09-12 08:01:26');

DROP TABLE IF EXISTS `ocs_customer`;
CREATE TABLE `ocs_customer` (
...
DROP TABLE IF EXISTS `ocs_customer_activity`;
CREATE TABLE `ocs_customer_activity` (
...
DROP TABLE IF EXISTS `ocs_customer_group`;
CREATE TABLE `ocs_customer_group` (
...
INSERT INTO `ocs_customer_group` (`customer_group_id`, `approval`, `sort_order`) VALUES
(1,	0,	1);

DROP TABLE IF EXISTS `ocs_customer_group_description`;
CREATE TABLE `ocs_customer_group_description` (
  `customer_group_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
...
INSERT INTO `ocs_customer_group_description` (`customer_group_id`, `language_id`, `name`, `description`) VALUES
(1,	1,	'Default',	'test');

DROP TABLE IF EXISTS `ocs_customer_history`;
CREATE TABLE `ocs_customer_history` (
...
DROP TABLE IF EXISTS `ocs_customer_ip`;
CREATE TABLE `ocs_customer_ip` (
...
DROP TABLE IF EXISTS `ocs_customer_login`;
CREATE TABLE `ocs_customer_login` (
...
DROP TABLE IF EXISTS `ocs_customer_online`;
CREATE TABLE `ocs_customer_online` (
  `ip` varchar(40) NOT NULL,
  `customer_id` int(11) NOT NULL,
  `url` text NOT NULL,
...
DROP TABLE IF EXISTS `ocs_customer_reward`;
CREATE TABLE `ocs_customer_reward` (
...
DROP TABLE IF EXISTS `ocs_customer_search`;
CREATE TABLE `ocs_customer_search` (
...
DROP TABLE IF EXISTS `ocs_customer_transaction`;
CREATE TABLE `ocs_customer_transaction` (
...
DROP TABLE IF EXISTS `ocs_customer_wishlist`;
CREATE TABLE `ocs_customer_wishlist` (
  `customer_id` int(11) NOT NULL,
  `product_id` int(11) NOT NULL,
  `date_added` datetime NOT NULL,
...
DROP TABLE IF EXISTS `ocs_custom_field`;
CREATE TABLE `ocs_custom_field` (
...
DROP TABLE IF EXISTS `ocs_custom_field_customer_group`;
CREATE TABLE `ocs_custom_field_customer_group` (
...
DROP TABLE IF EXISTS `ocs_custom_field_description`;
CREATE TABLE `ocs_custom_field_description` (
  `custom_field_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(128) NOT NULL,
...
DROP TABLE IF EXISTS `ocs_custom_field_value`;
CREATE TABLE `ocs_custom_field_value` (
...
DROP TABLE IF EXISTS `ocs_custom_field_value_description`;
CREATE TABLE `ocs_custom_field_value_description` (
...
DROP TABLE IF EXISTS `ocs_download`;
CREATE TABLE `ocs_download` (
...
DROP TABLE IF EXISTS `ocs_download_description`;
CREATE TABLE `ocs_download_description` (
...
DROP TABLE IF EXISTS `ocs_event`;
CREATE TABLE `ocs_event` (
...
INSERT INTO `ocs_event` (`event_id`, `code`, `trigger`, `action`, `status`, `date_added`) VALUES
(1,	'voucher',	'catalog/model/checkout/order/addOrderHistory/after',	'extension/total/voucher/send',	0,	'0000-00-00 00:00:00');

DROP TABLE IF EXISTS `ocs_extension`;
CREATE TABLE `ocs_extension` (
...
INSERT INTO `ocs_extension` (`extension_id`, `type`, `code`) VALUES
(1,	'payment',	'cod'),
(2,	'total',	'shipping'),
(3,	'total',	'sub_total'),
(4,	'total',	'tax'),
...
DROP TABLE IF EXISTS `ocs_filter`;
CREATE TABLE `ocs_filter` (
...
DROP TABLE IF EXISTS `ocs_filter_description`;
CREATE TABLE `ocs_filter_description` (
  `filter_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `filter_group_id` int(11) NOT NULL,
  `name` varchar(64) NOT NULL,
...
DROP TABLE IF EXISTS `ocs_filter_group`;
CREATE TABLE `ocs_filter_group` (
...
DROP TABLE IF EXISTS `ocs_filter_group_description`;
CREATE TABLE `ocs_filter_group_description` (
  `filter_group_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(64) NOT NULL,
...
DROP TABLE IF EXISTS `ocs_geo_zone`;
CREATE TABLE `ocs_geo_zone` (
...
INSERT INTO `ocs_geo_zone` (`geo_zone_id`, `name`, `description`, `date_modified`, `date_added`) VALUES
(3,	'Зона НДС',	'Облагаемые НДС',	'2014-09-09 11:48:13',	'2014-05-21 22:30:20');

DROP TABLE IF EXISTS `ocs_information`;
CREATE TABLE `ocs_information` (
...
INSERT INTO `ocs_information` (`information_id`, `bottom`, `sort_order`, `status`) VALUES
(3,	1,	3,	1),
(4,	1,	1,	1),
(5,	1,	4,	1),
(6,	1,	2,	1);

DROP TABLE IF EXISTS `ocs_information_description`;
CREATE TABLE `ocs_information_description` (
...
INSERT INTO `ocs_information_description` (`information_id`, `language_id`, `title`, `description`, `meta_title`, `meta_description`, `meta_keyword`) VALUES
(4,	1,	'О нас',	'&lt;p&gt;\r\n	About Us&lt;/p&gt;',	'О нас',	'',	''),
...
DROP TABLE IF EXISTS `ocs_information_to_layout`;
CREATE TABLE `ocs_information_to_layout` (
  `information_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  `layout_id` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `ocs_information_to_store`;
CREATE TABLE `ocs_information_to_store` (
  `information_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  PRIMARY KEY (`information_id`,`store_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

INSERT INTO `ocs_information_to_store` (`information_id`, `store_id`) VALUES
(3,	0),
(4,	0),
(5,	0),
(6,	0);

DROP TABLE IF EXISTS `ocs_language`;
CREATE TABLE `ocs_language` (
...
INSERT INTO `ocs_language` (`language_id`, `name`, `code`, `locale`, `image`, `directory`, `sort_order`, `status`) VALUES
(1,	'Russian',	'ru-ru',	'ru_RU.UTF-8,ru_RU,russian',	'ru-ru.png',	'russian',	1,	1);

DROP TABLE IF EXISTS `ocs_layout`;
CREATE TABLE `ocs_layout` (
  `layout_id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(64) NOT NULL,
  PRIMARY KEY (`layout_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

INSERT INTO `ocs_layout` (`layout_id`, `name`) VALUES
(1,	'Home'),
(2,	'Product'),
(3,	'Category'),
(4,	'Default'),
...
DROP TABLE IF EXISTS `ocs_layout_module`;
CREATE TABLE `ocs_layout_module` (
...
INSERT INTO `ocs_layout_module` (`layout_module_id`, `layout_id`, `code`, `position`, `sort_order`) VALUES
(2,	4,	'0',	'content_top',	0),
(3,	4,	'0',	'content_top',	1),
...
DROP TABLE IF EXISTS `ocs_layout_route`;
CREATE TABLE `ocs_layout_route` (
...
INSERT INTO `ocs_layout_route` (`layout_route_id`, `layout_id`, `store_id`, `route`) VALUES
(38,	6,	0,	'account/%'),
(17,	10,	0,	'affiliate/%'),
...
DROP TABLE IF EXISTS `ocs_length_class`;
CREATE TABLE `ocs_length_class` (
  `length_class_id` int(11) NOT NULL AUTO_INCREMENT,
  `value` decimal(15,8) NOT NULL,
  PRIMARY KEY (`length_class_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

INSERT INTO `ocs_length_class` (`length_class_id`, `value`) VALUES
(1,	1.00000000),
(2,	10.00000000),
(3,	0.39370000);

DROP TABLE IF EXISTS `ocs_length_class_description`;
CREATE TABLE `ocs_length_class_description` (
...
INSERT INTO `ocs_length_class_description` (`length_class_id`, `language_id`, `title`, `unit`) VALUES
(1,	1,	'Сантиметр',	'см'),
(2,	1,	'Миллиметр',	'мм');

DROP TABLE IF EXISTS `ocs_location`;
CREATE TABLE `ocs_location` (
...
DROP TABLE IF EXISTS `ocs_manufacturer`;
CREATE TABLE `ocs_manufacturer` (
...
INSERT INTO `ocs_manufacturer` (`manufacturer_id`, `name`, `image`, `sort_order`) VALUES
...
DROP TABLE IF EXISTS `ocs_manufacturer_to_store`;
CREATE TABLE `ocs_manufacturer_to_store` (
  `manufacturer_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  PRIMARY KEY (`manufacturer_id`,`store_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

INSERT INTO `ocs_manufacturer_to_store` (`manufacturer_id`, `store_id`) VALUES
(5,	0),
(6,	0),
(7,	0),
(8,	0),
...
DROP TABLE IF EXISTS `ocs_marketing`;
CREATE TABLE `ocs_marketing` (
...
DROP TABLE IF EXISTS `ocs_menu`;
CREATE TABLE `ocs_menu` (
...
DROP TABLE IF EXISTS `ocs_menu_description`;
CREATE TABLE `ocs_menu_description` (
...
DROP TABLE IF EXISTS `ocs_menu_module`;
CREATE TABLE `ocs_menu_module` (
...
DROP TABLE IF EXISTS `ocs_modification`;
CREATE TABLE `ocs_modification` (
...
DROP TABLE IF EXISTS `ocs_module`;
CREATE TABLE `ocs_module` (
...
INSERT INTO `ocs_module` (`module_id`, `name`, `code`, `setting`) VALUES
...
DROP TABLE IF EXISTS `ocs_option`;
CREATE TABLE `ocs_option` (
...
INSERT INTO `ocs_option` (`option_id`, `type`, `sort_order`) VALUES
(1,	'radio',	1),
(2,	'checkbox',	2),
(4,	'text',	3),
(5,	'select',	4),
...
DROP TABLE IF EXISTS `ocs_option_description`;
CREATE TABLE `ocs_option_description` (
...
INSERT INTO `ocs_option_description` (`option_id`, `language_id`, `name`) VALUES
(1,	1,	'Radio'),
(2,	1,	'Checkbox'),
(4,	1,	'Text'),
(6,	1,	'Textarea'),
...
DROP TABLE IF EXISTS `ocs_option_value`;
CREATE TABLE `ocs_option_value` (
...
INSERT INTO `ocs_option_value` (`option_value_id`, `option_id`, `image`, `sort_order`) VALUES
(43,	1,	'',	3),
(32,	1,	'',	1),
(45,	2,	'',	4),
(44,	2,	'',	3),
...
DROP TABLE IF EXISTS `ocs_option_value_description`;
CREATE TABLE `ocs_option_value_description` (
...
INSERT INTO `ocs_option_value_description` (`option_value_id`, `language_id`, `option_id`, `name`) VALUES
(43,	1,	1,	'Large'),
(32,	1,	1,	'Small'),
(45,	1,	2,	'Checkbox 4'),
(44,	1,	2,	'Checkbox 3'),
...
DROP TABLE IF EXISTS `ocs_order`;
CREATE TABLE `ocs_order` (
...
DROP TABLE IF EXISTS `ocs_order_custom_field`;
CREATE TABLE `ocs_order_custom_field` (
...
DROP TABLE IF EXISTS `ocs_order_history`;
CREATE TABLE `ocs_order_history` (
...
DROP TABLE IF EXISTS `ocs_order_option`;
CREATE TABLE `ocs_order_option` (
...
DROP TABLE IF EXISTS `ocs_order_product`;
CREATE TABLE `ocs_order_product` (
...
DROP TABLE IF EXISTS `ocs_order_recurring`;
CREATE TABLE `ocs_order_recurring` (
...
DROP TABLE IF EXISTS `ocs_order_recurring_transaction`;
CREATE TABLE `ocs_order_recurring_transaction` (
...
DROP TABLE IF EXISTS `ocs_order_status`;
CREATE TABLE `ocs_order_status` (
...
INSERT INTO `ocs_order_status` (`order_status_id`, `language_id`, `name`) VALUES
(1,	1,	'Ожидание'),
(2,	1,	'В обработке'),
(3,	1,	'Доставлено'),
(7,	1,	'Отменено'),
...
DROP TABLE IF EXISTS `ocs_order_total`;
CREATE TABLE `ocs_order_total` (
...
DROP TABLE IF EXISTS `ocs_order_voucher`;
CREATE TABLE `ocs_order_voucher` (
...
DROP TABLE IF EXISTS `ocs_product`;
CREATE TABLE `ocs_product` (
...
DROP TABLE IF EXISTS `ocs_product_attribute`;
CREATE TABLE `ocs_product_attribute` (
  `product_id` int(11) NOT NULL,
  `attribute_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `text` text NOT NULL,
...
INSERT INTO `ocs_product_attribute` (`product_id`, `attribute_id`, `language_id`, `text`) VALUES
(43,	2,	1,	'1'),
(47,	4,	1,	'16GB'),
(43,	4,	1,	'8gb'),
(42,	3,	1,	'100mhz'),
...
DROP TABLE IF EXISTS `ocs_product_description`;
CREATE TABLE `ocs_product_description` (
  `product_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL,
  `description` text NOT NULL,
...
INSERT INTO `ocs_product_description` (`product_id`, `language_id`, `name`, `description`, `tag`, `meta_title`, `meta_description`, `meta_keyword`) VALUES
(35,	1,	'Product 8',	'&lt;p&gt;\r\n	Product 8&lt;/p&gt;\r\n',	'',	'Product 8',	'',	''),
...
DROP TABLE IF EXISTS `ocs_product_discount`;
CREATE TABLE `ocs_product_discount` (
...
INSERT INTO `ocs_product_discount` (`product_discount_id`, `product_id`, `customer_group_id`, `quantity`, `priority`, `price`, `date_start`, `date_end`) VALUES
...
DROP TABLE IF EXISTS `ocs_product_filter`;
CREATE TABLE `ocs_product_filter` (
  `product_id` int(11) NOT NULL,
  `filter_id` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `ocs_product_image`;
CREATE TABLE `ocs_product_image` (
...
INSERT INTO `ocs_product_image` (`product_image_id`, `product_id`, `image`, `sort_order`) VALUES
...
DROP TABLE IF EXISTS `ocs_product_option`;
CREATE TABLE `ocs_product_option` (
...
INSERT INTO `ocs_product_option` (`product_option_id`, `product_id`, `option_id`, `value`, `required`) VALUES
(224,	35,	11,	'',	1),
...
DROP TABLE IF EXISTS `ocs_product_option_value`;
CREATE TABLE `ocs_product_option_value` (
...
INSERT INTO `ocs_product_option_value` (`product_option_value_id`, `product_option_id`, `product_id`, `option_id`, `option_value_id`, `quantity`, `subtract`, `price`, `price_prefix`, `points`, `points_prefix`, `weight`, `weight_prefix`) VALUES
...
DROP TABLE IF EXISTS `ocs_product_recurring`;
CREATE TABLE `ocs_product_recurring` (
  `product_id` int(11) NOT NULL,
  `recurring_id` int(11) NOT NULL,
  `customer_group_id` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `ocs_product_related`;
CREATE TABLE `ocs_product_related` (
  `product_id` int(11) NOT NULL,
  `related_id` int(11) NOT NULL,
  PRIMARY KEY (`product_id`,`related_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

INSERT INTO `ocs_product_related` (`product_id`, `related_id`) VALUES
(40,	42),
(41,	42),
(42,	40),
(42,	41);

DROP TABLE IF EXISTS `ocs_product_reward`;
CREATE TABLE `ocs_product_reward` (
...
INSERT INTO `ocs_product_reward` (`product_reward_id`, `product_id`, `customer_group_id`, `points`) VALUES
(515,	42,	1,	100),
(519,	47,	1,	300),
(379,	28,	1,	400),
(329,	43,	1,	600),
...
DROP TABLE IF EXISTS `ocs_product_special`;
CREATE TABLE `ocs_product_special` (
...
INSERT INTO `ocs_product_special` (`product_special_id`, `product_id`, `customer_group_id`, `priority`, `price`, `date_start`, `date_end`) VALUES
(419,	42,	1,	1,	90.0000,	'0000-00-00',	'0000-00-00'),
(439,	30,	1,	2,	90.0000,	'0000-00-00',	'0000-00-00'),
(438,	30,	1,	1,	80.0000,	'0000-00-00',	'0000-00-00');

DROP TABLE IF EXISTS `ocs_product_to_category`;
CREATE TABLE `ocs_product_to_category` (
  `product_id` int(11) NOT NULL,
  `category_id` int(11) NOT NULL,
...
INSERT INTO `ocs_product_to_category` (`product_id`, `category_id`) VALUES
(28,	20),
(28,	24),
(29,	20),
(29,	24),
...
DROP TABLE IF EXISTS `ocs_product_to_download`;
CREATE TABLE `ocs_product_to_download` (
  `product_id` int(11) NOT NULL,
  `download_id` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `ocs_product_to_layout`;
CREATE TABLE `ocs_product_to_layout` (
  `product_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  `layout_id` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `ocs_product_to_store`;
CREATE TABLE `ocs_product_to_store` (
  `product_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`product_id`,`store_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

INSERT INTO `ocs_product_to_store` (`product_id`, `store_id`) VALUES
(28,	0),
(29,	0),
(30,	0),
(31,	0),
...
DROP TABLE IF EXISTS `ocs_recurring`;
CREATE TABLE `ocs_recurring` (
...
DROP TABLE IF EXISTS `ocs_recurring_description`;
CREATE TABLE `ocs_recurring_description` (
  `recurring_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL,
...
DROP TABLE IF EXISTS `ocs_return`;
CREATE TABLE `ocs_return` (
...
DROP TABLE IF EXISTS `ocs_return_action`;
CREATE TABLE `ocs_return_action` (
...
INSERT INTO `ocs_return_action` (`return_action_id`, `language_id`, `name`) VALUES
(1,	1,	'Возвращены средства'),
(2,	1,	'Выдан в кредит'),
(3,	1,	'Отправлен другой товар для замены');

DROP TABLE IF EXISTS `ocs_return_history`;
CREATE TABLE `ocs_return_history` (
...
DROP TABLE IF EXISTS `ocs_return_reason`;
CREATE TABLE `ocs_return_reason` (
...
INSERT INTO `ocs_return_reason` (`return_reason_id`, `language_id`, `name`) VALUES
...
DROP TABLE IF EXISTS `ocs_return_status`;
CREATE TABLE `ocs_return_status` (
...
INSERT INTO `ocs_return_status` (`return_status_id`, `language_id`, `name`) VALUES
(1,	1,	'Рассматриваемый'),
(3,	1,	'Готов (к отправке)'),
(2,	1,	'Заказ в ожидании');

DROP TABLE IF EXISTS `ocs_review`;
CREATE TABLE `ocs_review` (
...
DROP TABLE IF EXISTS `ocs_setting`;
CREATE TABLE `ocs_setting` (
...
INSERT INTO `ocs_setting` (`setting_id`, `store_id`, `code`, `key`, `value`, `serialized`) VALUES
...
(174,	0,	'config',	'config_email',	'weblips@gmail.com',	0),
...
(175,	0,	'config',	'config_encryption',	'',	0),
...
DROP TABLE IF EXISTS `ocs_stock_status`;
CREATE TABLE `ocs_stock_status` (
...
INSERT INTO `ocs_stock_status` (`stock_status_id`, `language_id`, `name`) VALUES
(7,	1,	'В наличии'),
(8,	1,	'Предзаказ'),
(5,	1,	'Нет в наличии'),
(6,	1,	'Ожидание 2-3 дня');

DROP TABLE IF EXISTS `ocs_store`;
CREATE TABLE `ocs_store` (
...
DROP TABLE IF EXISTS `ocs_tax_class`;
CREATE TABLE `ocs_tax_class` (
...
INSERT INTO `ocs_tax_class` (`tax_class_id`, `title`, `description`, `date_added`, `date_modified`) VALUES
(9,	'Налоги',	'Облагаемые налогом',	'2014-06-06 23:00:00',	'2014-09-09 11:50:31');

DROP TABLE IF EXISTS `ocs_tax_rate`;
CREATE TABLE `ocs_tax_rate` (
...
INSERT INTO `ocs_tax_rate` (`tax_rate_id`, `geo_zone_id`, `name`, `rate`, `type`, `date_added`, `date_modified`) VALUES
(87,	3,	'НДС',	18.0000,	'F',	'2011-09-21 21:49:23',	'2014-09-09 11:49:32');

DROP TABLE IF EXISTS `ocs_tax_rate_to_customer_group`;
CREATE TABLE `ocs_tax_rate_to_customer_group` (
  `tax_rate_id` int(11) NOT NULL,
  `customer_group_id` int(11) NOT NULL,
  PRIMARY KEY (`tax_rate_id`,`customer_group_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

INSERT INTO `ocs_tax_rate_to_customer_group` (`tax_rate_id`, `customer_group_id`) VALUES
(86,	1),
(87,	1);

DROP TABLE IF EXISTS `ocs_tax_rule`;
CREATE TABLE `ocs_tax_rule` (
...
INSERT INTO `ocs_tax_rule` (`tax_rule_id`, `tax_class_id`, `tax_rate_id`, `based`, `priority`) VALUES
(121,	10,	86,	'payment',	1),
(120,	10,	87,	'store',	0),
(128,	9,	86,	'shipping',	1),
(127,	9,	87,	'shipping',	2);

DROP TABLE IF EXISTS `ocs_theme`;
CREATE TABLE `ocs_theme` (
...
DROP TABLE IF EXISTS `ocs_translation`;
CREATE TABLE `ocs_translation` (
...
DROP TABLE IF EXISTS `ocs_upload`;
CREATE TABLE `ocs_upload` (
...
DROP TABLE IF EXISTS `ocs_url_alias`;
CREATE TABLE `ocs_url_alias` (
...
INSERT INTO `ocs_url_alias` (`url_alias_id`, `query`, `keyword`) VALUES
...
DROP TABLE IF EXISTS `ocs_user`;
CREATE TABLE `ocs_user` (
...
INSERT INTO `ocs_user` (`user_id`, `user_group_id`, `username`, `password`, `salt`, `firstname`, `lastname`, `email`, `image`, `code`, `ip`, `status`, `date_added`) VALUES
(1,	1,	'falcons',	'fec570e8abc804b6c205843ed4e463b2571c682f',	'vcnvtonld',	'John',	'Doe',	'weblips@gmail.com',	'',	'',	'127.0.0.1',	1,	'2016-09-12 10:06:30');

DROP TABLE IF EXISTS `ocs_user_group`;
CREATE TABLE `ocs_user_group` (
...
INSERT INTO `ocs_user_group` (`user_group_id`, `name`, `permission`) VALUES
...
DROP TABLE IF EXISTS `ocs_voucher`;
CREATE TABLE `ocs_voucher` (
...
DROP TABLE IF EXISTS `ocs_voucher_history`;
CREATE TABLE `ocs_voucher_history` (
...
DROP TABLE IF EXISTS `ocs_voucher_theme`;
CREATE TABLE `ocs_voucher_theme` (
  `voucher_theme_id` int(11) NOT NULL AUTO_INCREMENT,
  `image` varchar(255) NOT NULL,
  PRIMARY KEY (`voucher_theme_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

INSERT INTO `ocs_voucher_theme` (`voucher_theme_id`, `image`) VALUES
(8,	'catalog/demo/canon_eos_5d_2.jpg'),
(7,	'catalog/demo/gift-voucher-birthday.jpg'),
(6,	'catalog/demo/apple_logo.jpg');

DROP TABLE IF EXISTS `ocs_voucher_theme_description`;
CREATE TABLE `ocs_voucher_theme_description` (
  `voucher_theme_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(32) NOT NULL,
...
INSERT INTO `ocs_voucher_theme_description` (`voucher_theme_id`, `language_id`, `name`) VALUES
(6,	1,	'Новый год'),
(7,	1,	'День рождения'),
(8,	1,	'Другое');

DROP TABLE IF EXISTS `ocs_weight_class`;
CREATE TABLE `ocs_weight_class` (
  `weight_class_id` int(11) NOT NULL AUTO_INCREMENT,
  `value` decimal(15,8) NOT NULL DEFAULT '0.00000000',
  PRIMARY KEY (`weight_class_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

INSERT INTO `ocs_weight_class` (`weight_class_id`, `value`) VALUES
(1,	1.00000000),
(2,	1000.00000000),
(5,	2.20460000),
(6,	35.27400000);

DROP TABLE IF EXISTS `ocs_weight_class_description`;
CREATE TABLE `ocs_weight_class_description` (
...
INSERT INTO `ocs_weight_class_description` (`weight_class_id`, `language_id`, `title`, `unit`) VALUES
(1,	1,	'Килограмм',	'кг'),
(2,	1,	'Грамм',	'г');

DROP TABLE IF EXISTS `ocs_zone`;
CREATE TABLE `ocs_zone` (
...
INSERT INTO `ocs_zone` (`zone_id`, `country_id`, `name`, `code`, `status`) VALUES
(1,	20,	'Брест',	'BR',	1),
(2,	20,	'Гомель',	'HO',	1),
(3,	20,	'Минск',	'HM',	1),
(4,	20,	'Гродно',	'HR',	1),
...
DROP TABLE IF EXISTS `ocs_zone_to_geo_zone`;
CREATE TABLE `ocs_zone_to_geo_zone` (
...
INSERT INTO `ocs_zone_to_geo_zone` (`zone_to_geo_zone_id`, `country_id`, `zone_id`, `geo_zone_id`, `date_added`, `date_modified`) VALUES
